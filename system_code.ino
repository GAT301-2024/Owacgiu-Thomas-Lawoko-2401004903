...
// Wi-Fi credentials
const char *ssid = "wokozpro";
const char *password = "57,lawoko";

// Authentication
const char *ADMIN_USER = "lawoko";
...
// HTML Footer
String htmlFooter() {
  return "<footer>Group: Logical_Loopers<br>Developed by Owacgiu Thomas Lawoko</footer></body></html>";
}
